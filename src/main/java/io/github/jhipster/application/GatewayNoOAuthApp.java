...
@EnableZuulProxy
public class GatewayNoOAuthApp {

    private static final Logger log = LoggerFactory.getLogger(GatewayNoOAuthApp.class);

    private final Environment env;

    public GatewayNoOAuthApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes gatewayNoOAuth.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(GatewayNoOAuthApp.class);
